...
def run_localization_probe_benchmark(
    ...
    train_vecs = np.array([_to_protein_vector(embeddings[pid], method=feature_method) for pid in train_ids])
    test_vecs = np.array([_to_protein_vector(embeddings[pid], method=feature_method) for pid in test_ids])
